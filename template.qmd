...
# Components {background-color="#A51C30"}
...
# Tables {background-color="#A51C30"}
...
etable(mods, arraystretch = 1.5)
```

# Figures {background-color="#A51C30"}
...
# Summary {background-color="#A51C30"}
